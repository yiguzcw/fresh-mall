            ...
            <li class="flex align-center li2" v-for="(item, index) in List" :key="index">
              ...
              <div class="box flex1 flex col bet">
                ...
                <div class="flex">
                  ...
                  <span class="type">
                    <img src="../../assets/img/icon/xianhuo.png" alt="" style="width:0.36rem;height:0.24rem" v-if="item.More.cate_type == 1">
                    <img src="../../assets/img/icon/qihuo.png" alt="" style="width:0.36rem;height:0.24rem" v-else>
                  </span>
                  <span class="description">{{item.More.name}}</span>
                </div>
                ...
                <div class="flex price bet align-center">
                  <span class="cf0">￥{{item.More.shu_price}}
                  ...
                  <span class="calc" v-if="edit">
                    <div class="flex">
                      <a class="flex1" @click="cartEdit('reduce', item.id)" >-</a>
                      <span class="flex1">{{item.productNum}}</span>
                      <a class="flex1" @click="cartEdit('increase', item.id, item.More.goodskc)">+</a>
                    </div>
                    <!-- <el-button size="mini" >-</el-button> <el-button size="mini" >+</el-button> -->
                  </span>

                  <span class="flex1" style="text-align:right" v-else>x {{item.productNum}}</span>
  ...
  methods: {
    ...
    checkPrice () {
      ...
      this.cartList.forEach(item => {
        console.log(item)
        let itemPrice = parseInt(item.More.shu_price)
